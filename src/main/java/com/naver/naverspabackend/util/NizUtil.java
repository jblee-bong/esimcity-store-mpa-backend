...
public class NizUtil {
    ...
    public NizUtil(String nizId,String nizPass,String nizPartnerCode,String baseUrl, EsimApiIngStepLogsService esimApiIngStepLogsService ){
        this.nizId = nizId;

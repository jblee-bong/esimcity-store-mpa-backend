...
public class NaverOrder {
    ...
    public List<OrderDto> buildOrderDtoList(List<Map<String, Object>> orderDetailList, StoreDto storeDto){
        ...
        for (Map<String, Object> objectMap : orderDetailList) {
            ...
            //String quantity = Objects.toString(productOrder.get("quantity"), "1");//최초수량
            String initialQuantity = Objects.toString(productOrder.get("initialQuantity"), "1");//최초주문수량
            String remainQuantity = Objects.toString(productOrder.get("remainQuantity"), "1");//잔여수량
            ...
            orderDto.setQuantity(Integer.parseInt(remainQuantity));
            orderDto.setAllQuantity(Integer.parseInt(initialQuantity));
            orderDto.setCancelQuantity(Integer.parseInt(initialQuantity)-Integer.parseInt(remainQuantity));

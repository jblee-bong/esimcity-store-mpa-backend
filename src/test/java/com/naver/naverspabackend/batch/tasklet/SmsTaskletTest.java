...
import com.naver.naverspabackend.mybatis.mapper.*;
...
class SmsTaskletTest {
    ...
    public void sendMessage(OrderDto orderDto, StoreDto storeDto) throws Exception {
        Gson gson = new Gson();
        TsimUtil tsimUtil = EsimUtil.getTsimUtil(null, storeDto, active);
        ...
        if (matchInfoDto == null) {
            System.out.println("matchInfo 없음");
            return;
        }
                ...
                if(matchInfoDto.getEsimType().equals("01")){
                    ...
                    try {
                        if(orderDto.getEsimApiRequestId()==null || orderDto.getEsimApiRequestId().equals("")){ //이심 요청 전
                            ...
                            if(esimMap!=null)
                                System.out.println("니즈 개통 상태 체크 : " + esimMap.toString());
                            ...
                            try{
                                System.out.println("updateOrderSmsForEsimIccid : " + esimMap.toString());
            ...
            for (String method : sendMethods) {
                ...
                if ("SMS".equals(method)  && onlyOneTrans) {
                    try {
                        ...
                        System.out.println("sms 발송 오류 ======================="+ e);
                        e.printStackTrace();
                    }
                    ...
                    try {
                        ...
                        System.out.println("mms 발송 오류 ======================="+ e);
                        e.printStackTrace();
                    }
                    totalCnt += perCnt;
                    ...
                    try {
                        ...
                        System.out.println("kakao 발송 오류 ======================="+ e);
                        e.printStackTrace();
                    }
                    totalCnt += perCnt;
                    ...
                    try {
                        ...
                        System.out.println("email 발송 오류 ======================="+ e);
                        e.printStackTrace();
                    }
                    totalCnt += perCnt;
                ...
                if (esimFlagInfo) {
                    ...
                    if ("E-SMS".equals(method)) {
                        try {
                            ...
                            System.out.println("e-sms 발송 오류 ======================="+ e);
                            e.printStackTrace();
                        }
                        totalCnt += perCnt;
                        ...
                        try {
                            ...
                            System.out.println("e-mms 발송 오류 ======================="+ e);
                            e.printStackTrace();
                        }
                        totalCnt += perCnt;
                        ...
                        try {
                            perCnt = kakaoService.requestSendKakaoMsg(sendMap, matchInfoDto.geteKakaoTemplateKey(),storeDto,orderDto,matchInfoDto.getEsimFlag(),null,false, shippingTel1);
                        } catch (Exception e) {
                            System.out.println("e-kakao 발송 오류 ======================="+ e);
                            e.printStackTrace();
                        }
                        totalCnt += perCnt;
                        ...
                        try {
                            ...
                            System.out.println("e-email 발송 오류 ======================="+ e);
                            e.printStackTrace();
                        }
                        totalCnt += perCnt;
